...
export const AccountBlockedScreen = ({ type, pauseType, pauseReason, pauseEstimatedResume }: AccountBlockedScreenProps) => {
      ...
      <div className="min-h-screen flex items-center justify-center bg-background relative overflow-hidden p-4">
        <Card className="max-w-md w-full glass-card border-red-500/30">
          <CardHeader className="text-center pb-2">
            ...
            <CardTitle className="text-xl text-foreground">Cuenta Eliminada</CardTitle>
          </CardHeader>
  ...
  return (
    <div className="min-h-screen flex items-center justify-center bg-background relative overflow-hidden p-4">
      <Card className="max-w-md w-full glass-card border-orange-500/30">
        <CardHeader className="text-center pb-2">
        ...
        <CardContent className="space-y-4 text-center">
          ...
          {pauseReason && (
            <div className="bg-muted/40 rounded-lg p-3 text-left">
              ...
              <p className="text-sm text-foreground">{pauseReason}</p>
            </div>
          )}
          {resumeDate && (
